    ...
    <footer id="contacts">
      <div className="footer-wrapper">
        <div className="footer-div">
          <ul style={{ marginBottom: 10 }} className="footer-links">
            <li>
            <NavLink to="/">
              О нас
            </NavLink>
            ...
            <li>
              Контакты: г. Бишкек, ул.Ибраимова 103, <br /> бизнес-центр
              “Victory”, 2 этаж, <br />
              тел. (0312) 911 330, 911 331, <br />
              0222 911330 <br />
              <a href="mailto:aryz@boi.kg">email: aryz@boi.kg</a>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-div">
          ...
          <div className="all-rights">
            <p>Институт Бизнес-омбудсмена</p>
            <p style={{ maxWidth: 200 }}>
              Сайт создан при финансовой поддержке Европейского банка
